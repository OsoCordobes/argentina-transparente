// lib/ocr.ts — Pipeline OCR para Boletines Oficiales argentinos.
//
// Diseño:
...
export interface OCRBoletinOptions {
...
export interface OCRBoletinResult {
  contratos: Contrato[]
  totalPaginas: number
...
export async function extraerBoletin(
  pdfBuffer: Buffer,
  opts: OCRBoletinOptions,
): Promise<OCRBoletinResult> {
